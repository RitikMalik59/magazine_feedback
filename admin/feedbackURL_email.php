...
if ($row_count > 0) {
    ...
    // );
    $mail->isHTML(true);
    $mail->Subject = 'Feedback URL link';
    ...
    foreach ($result as $row) {
        ...
        $encoded_id = $hashids->encode($id); // o2fXhV
        $feedback_url = SITEURL . '/index.php?_id=' . $encoded_id;
        // $decoded_id = $hashids->decode($id); // [1, 2, 3]
        ...
        try {
            ...
            if (true) {
                ...
                $row_count = $stmt->rowCount();
                echo 'is email sent updated to 1 of id: ' . $id . '<br>';
            }
        } catch (Exception $e) {
